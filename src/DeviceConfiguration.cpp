...
VRCommunicationConfiguration GetCommunicationConfiguration(const bool isRightHand) {
  ...
  switch (static_cast<VRCommunicationProtocol>(vr::VRSettings()->GetInt32(c_driverSettingsSection, "communication_protocol"))) {
    case VRCommunicationProtocol::NamedPipe: {
      ...
      return {VRCommunicationProtocol::NamedPipe, feedbackEnabled, VRCommunicationNamedPipeConfiguration{pipeName}};
    }
    ...
    case VRCommunicationProtocol::BtSerial: {
      ...
      return {VRCommunicationProtocol::BtSerial, feedbackEnabled, VRCommunicationBTSerialConfiguration{name}};
    }
    ...
    case VRCommunicationProtocol::Serial: {
      ...
      return {VRCommunicationProtocol::Serial, feedbackEnabled, VRCommunicationSerialConfiguration{port, baudRate}};
    }
  }
}
...
VRPoseConfiguration GetPoseConfiguration(bool isRightHand) {
...
VRDeviceConfiguration GetDeviceConfiguration(const vr::ETrackedControllerRole& role) {
  ...
  switch (static_cast<VRDeviceType>(vr::VRSettings()->GetInt32(c_driverSettingsSection, "device_driver"))) {
    case VRDeviceType::LucidGloves: {
      ...
      return {VRDeviceType::LucidGloves, serialNumber, role, poseConfiguration, VRDeviceLucidglovesConfiguration{serialNumber}};
    }
    default:
    ...
    case VRDeviceType::EmulatedKnuckles: {
      ...
      return {
          VRDeviceType::EmulatedKnuckles, serialNumber, role, poseConfiguration, VRDeviceKnucklesConfiguration{indexCurlAsTrigger, approximateThumb}};
    }
  }
}
...
VRDriverConfiguration GetDriverConfiguration(const vr::ETrackedControllerRole& role) {
  ...
  return {enabled, GetEncodingConfiguration(), GetCommunicationConfiguration(isRightHand), GetDeviceConfiguration(role)};
}